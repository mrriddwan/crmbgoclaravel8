...
class ContactImport implements ToModel, WithHeadingRow, SkipsEmptyRows
{
    ...
    public function model(array $row)
    {
        ...
        // $row['status_id'] = ContactStatus::where("id", "=", $row[4])->value('id');
        // $row['industry_id'] = ContactIndustry::where("id", "=", $row[3])->value('id');
        // $row['type_id'] = ContactType::where("id", "=", $row[5])->value('id');
        // $row['category_id']  = ContactCategory::where("id", "=", $row[6])->value('id');
        // $row['user_id'] = User::where("id", "=", $row[0])->value('id');
