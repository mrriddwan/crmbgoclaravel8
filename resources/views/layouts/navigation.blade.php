                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <div class="hidden sm:flex sm:items-center sm:ml-0 px-1">
                        <x-dropdown align="right" width="w-max">
                            ...
                            <x-slot name="content" class="w-full">
                                <x-nav-link class="w-full hover:bg-blue-300 hover:font-bold" :href="route('tutorial-contact')" :active="request()->routeIs('tutorial-contact')" >
                                    {{ __('Contact') }}
                                </x-nav-link>
                                
                                <br>
                                <x-nav-link class="w-full hover:bg-blue-300 hover:font-bold" :href="route('tutorial-todo_followup')" :active="request()->routeIs('tutorial-todo_followup')">
                                    {{ __('To Do & Follow Up') }}
                                </x-nav-link>
                            </x-slot>
                        </x-dropdown>
