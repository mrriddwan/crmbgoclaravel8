<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16 bg-slate-500 px-2 rounded-lg">
            <div class="flex">
                <!-- Logo -->
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-0 px-1">
                            <x-dropdown align="right" width="w-max">
                                ...
                                <x-slot name="content" class="w-full">
                                    <x-nav-link class="w-full text-xs font-bold hover:bg-blue-300 hover:font-bold"
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-0 px-1">
                            <x-dropdown align="right" width="w-max">
                                ...
                                <x-slot name="content" class="">
                                    <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('forecast')"
                                        :active="request()->routeIs('forecast')">
                                        {{ __('List') }}
                                    </x-nav-link>
                                    <br>
                                    @can('view forecast summary')
                                        <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('forecast-summary')"
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <div class="hidden sm:flex sm:items-center sm:ml-0 px-1">
                            <x-dropdown align="right" width="w-max">
                                ...
                                <x-slot name="content" class="">
                                    <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('billboard')"
                                        :active="request()->routeIs('billboard')">
                                        {{ __('Billboard') }}
                                    </x-nav-link>
                                    <br>
                                    <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('tempboard')"
                            ...
                            <x-dropdown align="right" width="w-max">
                                ...
                                <x-slot name="content" class="w-full text-xs">
                                    @can('view tracking general')
                                        <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('tracking-general')"
                                    ...
                                    @can('view tracking tguide')
                                        <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('tracking-travel_guide')"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <div class="hidden sm:flex sm:items-center sm:ml-0 px-1">
                        <x-dropdown align="right" width="w-max">
                            ...
                            <x-slot name="content" class="w-full">
                                <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('tutorial-contact')"
                                    :active="request()->routeIs('tutorial-contact')">
                                    {{ __('Contact') }}
                                </x-nav-link>

                                <br>
                                <x-nav-link class="w-full text-xs hover:bg-blue-300 hover:font-bold" :href="route('tutorial-todo_followup')"
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button x-on:click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-white transition duration-150 ease-in-out">
