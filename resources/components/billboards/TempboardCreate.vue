<template>
    <div class="container w-max align-center">
        ...
        <div class="text-center">
            <form
                @submit.prevent="createTempboard"
                ...
                <div class="grid grid-cols-1 items-center text-center">
                    ...
                    <div class="grid grid-cols-2 mt-2 gap-4">
                        <div class="grid grid-cols-1">
                            ...
                            <div>
                                <VueDatePicker
                                    v-model="form.tpboard_startdate"
                                    showNowButton
                                    nowButtonLabel="Today"
                                    :enableTimePicker="false"
                                    class="text-center w-full inline-block items-left mt-1 mx-2 rounded-md border-gray-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    ...
                    <div class="w-full">
                        <input
                            type="text"
                            class="text-center w-full inline-block items-left mt-1 mx-2 rounded-md border-gray-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            v-model="form.tpboard_collection"
                        />
                    </div>
                    <div class="w-full mt-2">
                        <label class="mx-2"
                    ...
                    <div class="w-full">
                        <input
                            type="text"
                            class="text-center w-full inline-block items-left mt-1 mx-2 rounded-md border-gray-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            v-model="form.tpboard_installation"
                        />
                    </div>
                    <div class="w-full mt-2">
                        <label class="mx-2"
        ...
        async createTempboard() {
            try {
                await axios.post("/api/tempboards/store", {
                    ...
                    tpboard_unit: this.form.tpboard_unit,
                    tpboard_collection: this.form.tpboard_collection,
